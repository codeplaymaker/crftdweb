...
export type ApplicantStatus = 'pending' | 'email_sent' | 'booked' | 'screened' | 'no_show' | 'rejected';
...
export const APPLICANTS: Applicant[] = [
  // ── ⭐⭐⭐⭐⭐ ──────────────────────────────────────────────────────
  {
    ...
    verdict: 'booking',
    salesSignals:
      '9+ yrs B2B SaaS. Saviynt (EMEA $3M pipeline), OpenText ($4.1M pipeline, 3× Top Performer, 68% meeting-to-opp rate), WarringtonFire (130% of target). SPIN/MEDDIC/Miller Heiman trained.',
    education: 'A-Levels',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      '7+ yrs B2B. TET (high-value IT/comms closing), XMA (£1M+ monthly accounts, Metropolitan Police/councils), BT Business Account Manager (SME/enterprise renewals & upsells). Career break since Dec 2024.',
    education: 'GCSEs',
  ...
  // ── ⭐⭐⭐⭐ ───────────────────────────────────────────────────────
  {
    ...
    verdict: 'booking',
    salesSignals:
      'BizDev Executive Lura Care (new business, pipeline, contracts), Senior Sales Negotiator RPS Estates (prospecting, valuations, completions), Senior Marketing Exec iProspect/Dentsu (18 international markets for NEXT).',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Telesales Advisor Hops & Barley 2yr (inbound/outbound, KPIs exceeded, CRM), Telesales Advisor Weddings Chester 1yr (15+ sales/week, 3+ daily), Screwfix upselling.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Sales Rep EZ Living Furniture remote (Salesforce CRM, exceeded monthly targets, cold calling, B2B), Customer Support Apple Ireland 2yr, Quality Specialist ThermoFisher.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Senior Energy Advisor ScottishPower door-to-door (exceeded KPIs, weekly signups, trained new staff), Holiday Lettings Manager (objection handling, repeat stays increased), Client Advisor Social Security Scotland.',
  ...
  // ── ⭐⭐⭐ ───────────────────────────────────────────────────────
  {
    ...
    verdict: 'booking',
    salesSignals:
      'B2B marketing at Oxford Uni event, exceeded daily sales targets, website management (WordPress, Shopify, Google Ads), brand ambassador Bumble (surpassed target), built landing page/purchase system.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Self-managed freelancer, social media management, AI workflow experience, targeting remote Lead Generation. Objection handling listed as skill. Rock climbing instructor (membership/coaching sales).',
    education: 'A-Levels',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Telesales Advisor Eco Wise Renewables 4 years — outbound/inbound, met and exceeded targets, objection handling, product knowledge.',
  ...
  // ── ⭐⭐ ────────────────────────────────────────────────────────
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Account Development Agent Link Mailing Systems (outbound calls, met targets, high call volume), River Island sales.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Student Recruitment Global Edu Care (outreach strategies, data tracking, proactive communication with prospects). Baker McKenzie internship (legal research).',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Salesperson Namaste Bengal (Oct 2025–Mar 2026), Sales Rep Islam Traders (5 yrs, 30–50 interactions/day), Student Ambassador Leeds Beckett.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Sales Exec, Brand Ambassador, Fundraising Rep (Rotary). Most experience appears self-employed/family businesses.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Executive Director family car dealership + real estate developer in Pakistan. Marketing, SaaS integration, social media growth.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Outbound calling: PPI, debt collection, B2B. Currently self-employed commission-only network marketing. Hits targets, self-motivated.',
  ...
  },
  {
    ...
    verdict: 'booking',
    salesSignals:
      'Security guard (current), 1-day volunteer cashier, 1-month Legoland sales associate, 1-month door-to-door Modern Milkman.',
