        ...
        <tr>
          <td style="background:#ffffff;border:1px solid #e0e0e0;border-top:none;border-radius:0 0 12px 12px;padding:40px;">
            ...
            <p style="margin:0 0 24px;font-size:15px;color:#444;line-height:1.7;">
              Before you accept, please review the contractor agreement so you know exactly how the role works:
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 12px;">
              <tr><td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:16px 20px;">
                ...
                <p style="margin:0;font-size:13px;color:#15803d;line-height:1.6;">
                  Commission ranges from 10&ndash;35% per closed deal, based on your career rank. Complete training to activate your first earning tier &mdash; full breakdown provided once you&rsquo;re onboard.
                </p>
              </td></tr>
            </table>

            <p style="margin:0 0 28px;font-size:14px;color:#666;line-height:1.7;">
              By clicking <strong>Accept</strong>, you confirm you&rsquo;ve read the contractor agreement and agree to its terms.
            </p>
...
1. Contractor Agreement — ${BASE_URL}/docs/rep-contractor-agreement.html

Commission: 10-35% per closed deal, based on your career rank. Complete training to activate your first earning tier — full breakdown provided once you're onboard.
