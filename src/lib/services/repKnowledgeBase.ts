    ...
    principles: [
      {
        ...
        exampleBad: 'So, we build custom websites starting from £1,200. Let me tell you what we do.',
  ...
  // 7. GAP SELLING — KEENAN
  {
    ...
    principles: [
      ...
      },
      {
        ...
        antiPatterns: [],
        exampleGood: 'If a decent site brought in just one extra job a month, and a typical job\'s worth £2k — that\'s £24k over a year from a £1,200 investment.',
